...
class ReservationRepository:
    ...
    def find_reservation_by_id(self, reservation_id: str) -> Reservation:
        try:
            ...
            query = f"SELECT * FROM {config.ENVIRONMENT}.Reservations WHERE id = ?"
    ...
    def get_available_hours(self, date: str) -> List[datetime]:
        try:
            ...
            query = f"SELECT * FROM {config.ENVIRONMENT}.Reservations WHERE start_date >= '{date} 00:00:00' AND end_date <= '{date} 23:59:59'"
            cursor.execute(query)
